...
namespace MyProject.API.UOW
{
    public class OrderUnitOfWork : UnitOfWork, IOrderUnitOfWork
    {
        ...
        public OrderUnitOfWork(ApplicationDbContext db, IDbContextTransaction transaction, IK03TRepository k03t, ID03TRepository d03t, ID03THRepository d03th) : base(db, transaction)
        {
            K03T = k03t;
            D03T = d03t;
            D03TH = d03th;
